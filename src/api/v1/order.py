...
def create_order(
    *,
    ...
    email_service.send_email(order_data.customer_email, f"Order Created {order_data}")
...
def create_order_2(
    *,
    ...
    send_email_task.delay(order_data.customer_email, f"Order Created {order_data}")
